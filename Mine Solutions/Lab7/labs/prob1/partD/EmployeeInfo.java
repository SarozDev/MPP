...
public class EmployeeInfo {
	...
	/**
	 * Removes all duplicate prob3.Employee instances from input list (only a copy is modified)
	 * An prob3.Employee instance is considered to be a duplicate of another prob3.Employee
...
//		List<prob3.Employee> list = new ArrayList<prob3.Employee>();
//		list.add(new prob3.Employee("Bill", 60000));
//		list.add(new prob3.Employee("Bill", 60000));
