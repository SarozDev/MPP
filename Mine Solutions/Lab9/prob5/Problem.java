...
//                .collect(Collectors.toList());
        ...
        //Comparator<Customer> alphabeticalSortedCusomter = Comparator.comparing(a->a.getCity());

        return list.stream()
                .filter(s->s.getZip().equals("52556"))
                .sorted(customerComparator.thenComparing(Customer::getCity))
    ...
    private static void testSecondMethod() {
        Customer cust1 = new Customer("Bob", "11 Adams", "Aairfield", "52556");
        ...
        Customer cust6 = new Customer("Anna", "10 Adams", "Bairfield", "52556");
